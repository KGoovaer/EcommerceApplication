...
<b>	<a href="cartnull.jsp" class="w3-bar-item w3-button" ><img src = images/cart.png height=40px alt=Cart></a>
  ...
  display: inline-block"><b style="color:white"><center><%=tqty %></center></b></span></b>
	...
	<a href="tv.jsp" class="w3-bar-item w3-button">Tv</a>&ensp;
	<a href="laptop.jsp" class="w3-bar-item w3-button">Laptop</a>&ensp;
	<a href="mobile.jsp" class="w3-bar-item w3-button">Mobile</a>&ensp;
	<a href="watch.jsp" class="w3-bar-item w3-button">Watch</a>&ensp;
